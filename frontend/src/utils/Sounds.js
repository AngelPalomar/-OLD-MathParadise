...
export const drawSound = new Howl({
    src: ['/sounds/draw_sound.wav']
})

export const tileSound = new Howl({
...
export const finishGameSound = new Howl({
    src: ['/sounds/game_finished_sound.wav']
})
